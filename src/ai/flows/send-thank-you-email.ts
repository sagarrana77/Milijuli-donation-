...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert in donor communications for a non-profit organization called ClarityChain. Your task is to write a warm, professional, and heartfelt thank-you email to a donor.
