...
export function LoginDialog() {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={closeDialog}>
      <DialogContent className="max-w-4xl p-0 gap-0 border-0 data-[state=open]:h-auto data-[state=open]:max-h-[90vh] data-[state=open]:overflow-y-auto" aria-describedby="login-dialog-description">
