...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("h-7 w-7 hidden lg:flex transition-transform duration-300 ease-in-out group-data-[collapsible=icon]:mx-auto", state === 'collapsed' && "rotate-180", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
